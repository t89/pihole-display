...
wget 192.168.100.247:8000/src/observer.py -P ./src/
wget 192.168.100.247:8000/src/housekeeper.py -P ./src/
wget 192.168.100.247:8000/src/network.py -P ./src/
wget 192.168.100.247:8000/location
wget 192.168.100.247:8000/known_clients
wget 192.168.100.247:8000/dev_update.sh
wget 192.168.100.247:8000/anim/intro.gif -P ./anim/
